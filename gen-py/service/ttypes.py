...
class FileChunk(object):
    ...
    def __init__(self, data=None, chunkSize=None,):
        self.data = data
    ...
    def write(self, oprot):
        ...
        if self.chunkSize is not None:
            oprot.writeFieldBegin('chunkSize', TType.I32, 2)
...
class FileMetadata(object):
    ...
    def __init__(self, filename=None, version=None, fileSize=None,):
    ...
    def write(self, oprot):
        ...
        if self.fileSize is not None:
            oprot.writeFieldBegin('fileSize', TType.I64, 3)
...
FileChunk.thrift_spec = (
    ...
    (2, TType.I32, 'chunkSize', None, None, ),  # 2
)
...
FileMetadata.thrift_spec = (
    ...
    (3, TType.I64, 'fileSize', None, None, ),  # 3
)
